...
const Testimonials = () => {
  return (
    <section className="relative z-10 bg-gray-100 py-16 dark:bg-gray-900 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          title="What Our Clients Say"
          paragraph="Hear from businesses that have experienced the KalaburagiTech difference in software development and IT solutions."
          center
        />
