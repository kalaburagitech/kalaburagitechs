            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  KalaburagiTech is a software development and IT services
                  company in Kalaburagi (Gulbarga), Karnataka—serving North
                  Karnataka and clients nationwide with web, mobile, cloud, and
                ...
                <div className="flex items-center">
                  ...
                  >
                    <svg
                      ...
                      fill="currentColor" // Ensures the SVG color inherits the parent's color
                    >
