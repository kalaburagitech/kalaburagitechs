          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                ...
                paragraph="At KalaburagiTech, we focus on delivering cutting-edge software solutions that empower businesses to thrive in the digital age. Our team of experts is dedicated to creating tailored applications that meet your unique needs."
                mb="44px"
              />
